 ...
 */
export const TbsContextProvider = ({ children }: TbsContextProviderProps) => {
...
//* Example of use
// import { TbsContextProvider } from "../../Context/ContextTBS";
// import { TbsPageContent } from "./TbsPageContent";

// export default function TbsBasePage(props: any) {
//     return(
//         <TbsContextProvider>
//             <TbsPageContent />
//         </TbsContextProvider>
