...
export function BallisticDropLineChart({ resultData: chartData, selectedCalibration }: BallisticCalculatorGraphProps) {
  ...
  const lineOfSightCustomLabel = (props: {
    ...
    return (
      <g>
        <text x={props.viewBox.x} y={props.viewBox.y} fill="#ffffff" dy={-10} dx={415}>
          Line of Sight
        </text>
      </g>
    );
