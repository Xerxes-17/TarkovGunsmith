...
{
    public class WG_TarkovDevAPICalls
    {
        public static async Task<JObject> TarkovDevQueryAsync(string queryDetails, string filename)
        {
            JObject result;
        ...
        public static JObject GetAllGunPresets()
        {
