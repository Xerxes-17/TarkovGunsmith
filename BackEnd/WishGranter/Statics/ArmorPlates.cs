...
namespace WishGranter.Statics
{
    ...
    public record class ArmorPlateOrInsert
    {
        [Key]
        ...
        [Required]
        public string UsedInId { get; set; } = string.Empty;
        [Required]
        public string UsedInName { get; set;} = string.Empty;
        ...
        //public static List<ArmorItemStats> GenerateListOfPlatesAndInserts(List<Item> armorList)
        //{
        //    var ArmorPlates = armorList.Where(x => x is ArmorPlate).Cast<ArmorPlate>();
